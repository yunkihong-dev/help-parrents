<?php
	...
	$sql = "SELECT n.id, n.title, n.content, u.user_nickname AS nickname, n.reg_date, n.hit , n.user_id user_id
			FROM tbl_notice n 
    ...
    <div id="board_box">
        ...
        <ul class="buttons">
			...
			<?php 
                ...
                ?>
                    <a class="letter-button" href="TINi_notice_modify_form.php?id=<?=$id?>&page=<?=$page?>">수정하기</a>
                    <a class="letter-button" href="notice_delete.php?id=<?=$id?>&page=<?=$page?>">삭제하기</a>
                <?php
                } 
                ?>
            </li>
