...
INSERT INTO tiniping.tini_goods_info
(title, content, place_name, hit, reg_date, tini_id, user_id)
VALUES('여기에 티니핑 장난감파네요!!', '여기서 사시면될거같아여!', '롯데마트 잠실점', 0, NOW(), 2, 2);
select * from tini_goods_info ;

drop table tini_goods_info;


-- tbl_goods_comment 테이블 생성
